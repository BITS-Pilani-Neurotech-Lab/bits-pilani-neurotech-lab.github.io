  ...
  return (
    <div className="relative w-full min-h-screen bg-black overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        {/* Video: Scaled down using object-contain and scale-105 */}
        <video
          autoPlay
          loop
          muted
      ...
      >
        {/* --- Standalone Visual/Pattern Doodle Tiles (Edge-to-Edge Fit) --- */}
        {illustrationCards.map((card, idx) => (
          <div
            key={idx}
            className={`bg-[#121212]/90 rounded-[28px] md:rounded-[40px] overflow-hidden flex items-center justify-center p-0 border border-zinc-800/50 shadow-lg ${card.mobileOrder} ${card.desktopClass}`}
          >
            <img
              src={card.src}
              alt={card.alt}
